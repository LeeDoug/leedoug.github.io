...
var controls = new function() {
    this.Reset = function () {
        this.xtrans = this.ytrans = this.zrot = 0.0;
...
function render() {
    ...
    redBox.rotation.z = controls.zrot;
...
function init() {
    ...
    var gui = new dat.GUI();
    gui.add(controls, 'xtrans', -20.0, 20.0);
    gui.add(controls, 'ytrans', -20.0, 20.0);
    gui.add(controls, 'zrot', 0.0, 2.0 * Math.PI);
    gui.add(controls, 'xscale', 0.1, 4.0);
    gui.add(controls, 'yscale', 0.1, 4.0);
