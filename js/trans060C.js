...
function init() {
    ...
    parentFolder.add(controls, 'xtransP', -20.0, 20.0);
    parentFolder.add(controls, 'ytransP', -20.0, 20.0);
    parentFolder.add(controls, 'zrotP', 0.0, 2.0 * Math.PI);
    parentFolder.add(controls, 'xscaleP', 0.1, 4.0);
    parentFolder.add(controls, 'yscaleP', 0.1, 4.0);
    parentFolder.open();
    var childFolder = gui.addFolder('Child');
    childFolder.add(controls, 'xtransC', -20.0, 20.0);
    childFolder.add(controls, 'ytransC', -20.0, 20.0);
    childFolder.add(controls, 'zrotC', 0.0, 2.0 * Math.PI);
    childFolder.add(controls, 'xscaleC', 0.1, 4.0);
    childFolder.add(controls, 'yscaleC', 0.1, 4.0);
    childFolder.open();
